...
4. EXTRACT EVERY STUDY VISIT from the SOA columns (e.g. Screening, Baseline, Randomization, Day 1, Week 4/8/12, End of Treatment, End of Study, Follow-Up). Capture each visit's sequence, timing, and window. Continuous/unscheduled collections (Adverse Events, Concomitant Medications) are kind "log".
